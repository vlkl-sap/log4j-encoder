...
public final class EncodingPatternConverterAlt extends LogEventPatternConverter {
    ...
    /**
     * Creates an EncodingPatternConverterAlt using a pattern string and an optional escape format.
     *
     * @param config  the current Configuration
     * @param options first option is the nested pattern format; second option is the escape format (optional)
     * @return instance of pattern converter.
     */
    public static EncodingPatternConverterAlt newInstance(final Configuration config, final String[] options) {
